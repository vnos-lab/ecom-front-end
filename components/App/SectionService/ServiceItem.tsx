...
function ServiceItem(props: FooterItemProps) {
  ...
  return (
    <div className="flex flex-col items-center w-max max-w-[262px] gap-y-[24px]">
      ...
      <div className="flex flex-col items-center justify-center lg:gap-x-1 w-max  font-poppins text-black">
        <div className="text-[15px] leading-5 lg:text-[20px] md:text-[18px] lg:leading-7  font-semibold">
          {title}
        </div>
        <div className="text-[12px] lg:text-[14px] leading-[21px]">
          {description}
        </div>
      </div>
    </div>
